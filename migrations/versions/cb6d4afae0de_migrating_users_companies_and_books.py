"""Migrating users,companies and books.

Revision ID: cb6d4afae0de
Revises: 
Create Date: 2025-03-19 17:25:35.423007
...
def upgrade():
    ...
    sa.Column('isnb', sa.String(length=30), nullable=True),
